...
class OrderLineItem(models.Model):
    ...
    carpet_length = models.CharField(max_length=10, null=True, blank=True)
    carpet_width = models.CharField(max_length=10, null=True, blank=True)
    carpet_colour = models.CharField(max_length=100, null=True, blank=True) 
